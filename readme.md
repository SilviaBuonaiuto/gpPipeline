...
#### 5. Parsing VEP annotations with [grep.csq.sql.py](https://github.com/SilviaBuonaiuto/gpPipeline/tree/master/scr/grep.csq.sql.py)
 per chromosome
 ```
 Options :
...
#### 7. Filter variable sites with [grep.filter.all.slq.py](https://github.com/SilviaBuonaiuto/gpPipeline/tree/master/scr/grep.filter.all.slq.py)
per chromosome 
```
Options :
...
#### 8. Format results with [grep.curation_nolow.R](https://github.com/SilviaBuonaiuto/gpPipeline/tree/master/scr/grep.curation_nolow.R) 
